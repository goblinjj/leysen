        ...
        .then(res => {
          ...
          wx.showToast({
            ...
            complete: function () {
              setTimeout(() => {
                wx.navigateTo({
                  url: '/pages/orderAction/send?order_number=' + that.data.order_id + '&pic=' + that.data.cardList[that.data.choosed].pic_url + '&name=' + that.data.cardList[that.data.choosed].name
                });
              }, 1500);
            }
          });
